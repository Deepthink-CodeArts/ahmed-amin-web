...
export default function NewGlobalPresence() {
        ...
        <div className="mb-16">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { icon: Globe, label: "Countries", value: regions.find(r => r.id === selectedRegion)?.countries },
                { icon: Building, label: "Offices", value: regions.find(r => r.id === selectedRegion)?.offices },
                { icon: Users, label: "Employees", value: regions.find(r => r.id === selectedRegion)?.employees?.toLocaleString() },
