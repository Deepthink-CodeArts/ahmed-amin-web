...
export default function WaveDivider({ variant = "wave1" }) {
  const waves = {
    wave1: (
    ...
    wave3: (
      <svg className="w-full h-24" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <defs>
          ...
          <linearGradient id="wave3Gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  return (
    <div className="relative">
      <div className={`${variant === 'wave3' ? 'animate-pulse' : ''}`}>
        {waves[variant]}
      </div>
    </div>
  );
