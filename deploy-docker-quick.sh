...
# Ahmed Amin Group - Quick Docker Deployment (Random high port)
echo "🐳 Quick Docker deployment to ahmedamin.deepthinkcodearts.com..."
...
# Use a random high port (9000-9999)
PORT=$((9000 + RANDOM % 1000))
print_step "Using random port: $PORT"

print_step "1. Stopping existing container..."
...
print_step "3. Running container on port $PORT..."
docker run -d \
...
print_step "4. Setting up Nginx proxy..."
...
print_status "🎉 Quick Docker deployment completed!"
print_status "Container running on port: $PORT"
